...
$$M^t = f_M(Q^t, K_p) = \text{Softmax}\left(\frac{Q^t K_p^T}{\sqrt{d}}\right), \quad M^t \in \mathbb{R}^{(n, h \times w, l)} \tag{1}$$
...
$$\mathbb{W} = [\mathcal{W}_p, \mathcal{W}_1, \mathcal{W}_2, \ldots, \mathcal{W}_k], \quad \mathcal{W}_i = \text{CLIP}_{\text{text}}(c_i), \quad i = 1, \ldots, k \tag{2}$$
...
$$\mathbb{V} = [f_V(\mathcal{W}_p), f_V(\overline{\mathcal{W}_1}), \ldots, f_V(\overline{\mathcal{W}_k})] = [V_p, V_1, \ldots, V_k] \tag{3}$$

$$O^t = \frac{1}{(k+1)} \sum_{i} (M^t V_i), \quad i = p, 1, 2, \ldots, k \tag{4}$$
...
$$\mathbb{K} = \{f_K(\overline{\mathcal{W}_i})\}, \quad \mathbb{M}^t = \{f_M(Q^t, K_i)\}, \quad i = p, 1, 2, \ldots, k \tag{5}$$

$$O^t = \frac{1}{(k+1)} \sum_{i} (M_i^t V_k), \quad i = p, 1, 2, \ldots, k \tag{6}$$
